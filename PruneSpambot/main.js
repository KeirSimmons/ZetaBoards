...
Modification: Prune Spambot (previously: Edit/ Delete Posts/Topics by User)
*/
...
var post_delete = {
	...
	start_posts: function() {
		$.get(main_url + "search/?force_ads&c=2&mid=" + post_delete.zbid, function(e) {
	...
	action: {
		posts: {
			remove: function(e, t, n, r) {
				$.get(main_url + "mod/?force_ads&c=24&f=" + n + "&t=" + t + "&p=" + e, function(e) {
					if (post_delete.no_errors(e)) {
			...
			edit: function(e, t, n, r) {
				$.get(main_url + "post/?force_ads&mode=3&type=1&f=" + n + "&t=" + t + "&p=" + e, function(e) {
					if (post_delete.no_errors(e)) {
